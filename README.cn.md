...
[![x-cmd/install — hackernews-TUI Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/hackernews-TUI.svg?lang=zh)](https://x-cmd.com/install/hackernews-TUI)

## 安装

```sh
x install hackernews-TUI
```

## 代码洞察

合计: **5,709** 行代码（覆盖前 5 种语言、共 **41** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 5,401 | 198 | 720 | 31 |
| Toml | 299 | 72 | 47 | 7 |
| Dockerfile | 9 | 0 | 1 | 1 |
| Markdown | 0 | 342 | 143 | 2 |

## 源代码

- **上游仓库**: <https://github.com/aome510/hackernews-TUI>
- **许可证**: MIT
...
- **Star**: 720 · **Fork**: 33 · **开放 issue**: 35 · **贡献者**: 13

## 累计统计

- **发布数**: 32 · **已合并 PR**: 75 · **开放 PR**: 3 · **已关闭 issue**: 28 · **开放 issue**: 7 · **提交数**: 500
...
| 360d | 2025-09-28 | 0 | 0 | 1 | 0 | 2 | 1 |
| last720d | 2024-10-03 | 1 | 1 | 3 | 1 | 3 | 4 |
...
hackernews-TUI 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `hackernews-TUI` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/hackernews-TUI.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:31:31Z._
